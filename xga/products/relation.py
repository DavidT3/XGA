...
#  Last modified by David J Turner (turne540@msu.edu) 26/02/2024, 18:40. Copyright (c) The Contributors
...
class ScalingRelation:
    ...
    def predict(self, x_values: Quantity, redshift: Union[float, np.ndarray] = None,
        ...
        if x_errors is not None and self.model_func == power_law:
            ...
            term_three = ((self.y_norm.value*(1/ez)*self.pars[1, 0]*((x_values.value/self.x_norm.value)**self.pars[0, 0])*np.log(x_values.value/self.x_norm.value))*x_errors.value)**2
