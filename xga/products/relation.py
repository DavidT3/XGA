...
class ScalingRelation:
    ...
    def __init__(self, fit_pars: np.ndarray, fit_par_errs: np.ndarray, model_func, x_norm: Quantity, y_norm: Quantity,
                 ...
                 core_excised: bool = True, core_size: float = 0.15):
        """
        ...
        # The default is core excised (True), but this can be set to False to use core-included relations
        self._core_excised = core_excised

        # The default core size is 0.15xR_vir, but this can be set to a different size or core included (0)
