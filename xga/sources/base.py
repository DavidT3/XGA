...
#  Last modified by David J Turner (turne540@msu.edu) 10/07/2025, 13:57. Copyright (c) The Contributors
import gc
import os
import pickle
...
class BaseSource:
    ...
    def __init__(self, ra: float, dec: float, redshift: float = None, name: str = None,
        ...
        if 'erass' in telescope or ('erass' not in ALLOWED_INST and 'erosita' in telescope):
            ...
            if not (gal_udc.l > Quantity(179.94423568) and gal_udc.b <= Quantity(359.94423568, 'deg')):
