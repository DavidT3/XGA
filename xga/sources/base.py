...
class BaseSource:
    ...
    def _get_spec_prod(self, outer_radius: Union[str, Quantity], obs_id: str = None, inst: str = None,
        ...
        # - Scenario 1: Single obs + multi inst (obs_id='227093', inst='combined')
        # - Scenario 2: Multi obs + single inst (obs_id='combined', inst='tm1')
        # - Scenario 3: Multi obs + multi inst (obs_id='combined', inst='combined')
        if obs_id == 'combined' or inst == 'combined':
    ...
    def get_combined_lightcurves(self, outer_radius: Union[str, Quantity] = None,
        ...
        # NOTE: This method was not updated to use the unified obs_id='combined'/inst='combined' pattern
        # as combined lightcurves are not yet implemented. When implementation is complete, this should
        # follow the same pattern as get_combined_spectra/images/profiles (i.e., wrapper around get_lightcurves
        # with obs_id='combined' as default).
