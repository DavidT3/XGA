...
from ..products.profile import ProjectedGasTemperature1D, APECNormalisation1D, GasDensity3D
...
class GalaxyCluster(ExtendedSource):
    ...
    def get_density_profiles(self, outer_rad: Union[Quantity, str], method: str, obs_id: str = None,
        ...
        elif (obs_id == "combined" or inst == "combined" or obs_id is None or inst is None or link_norm) \
                and method == 'spec':
        ...
        if method != 'spec' and any([p.density_method == method for p in interim_prods]):
            ...
            raise NoProductAvailableError("Density profiles for this cluster, outer radius, and ObsID/Instrument "
                                          "exist, but no matches can be found for this specific method.")
