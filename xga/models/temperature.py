...
class SimpleVikhlininTemperature1D(BaseModel1D):
    ...
    @staticmethod
    def model(x: Quantity, r_cool: Quantity, a_cool: Quantity, t_min: Quantity, t_zero: Quantity,
              r_transition: Quantity, c_power: Quantity) -> Quantity:
        """
        ...
        :param Quantity r_transition: The radius of the transition region of this broken power law model.
