...
#  Last modified by David J Turner (turne540@msu.edu) 15/09/2025, 16:05. Copyright (c) The Contributors
...
arnaud_r500 = ScalingRelation(np.array([0.57, 1104]), np.array([0.02, 13]), power_law, Quantity(5, 'keV'),
                              ...
                              relation_year='2005', relation_doi='10.1051/0004-6361:20052856', dim_hubb_ind=1,
                              telescope='xmm', outer_aperture='R500')
...
arnaud_r2500 = ScalingRelation(np.array([0.56, 491]), np.array([0.02, 4]), power_law, Quantity(5, 'keV'),
                               ...
                               relation_year='2005', relation_doi='10.1051/0004-6361:20052856', dim_hubb_ind=1,
                               telescope='xmm', outer_aperture='R2500')

# These are equivalent relations specifically measured from the hot clusters (T > 3.5keV) in their sample
...
# These are from the classic M-T relation paper published by Vikhlinin, as R-T relations are a
#  byproduct of M-T relations
# TODO Double check this
vikhlinin_r2500 = ScalingRelation(np.array([1.64/3, 351]), np.array([0.06/3, 5]), power_law, Quantity(5, 'keV'),
                                  Quantity(1, 'kpc'), r"T$_{\rm{x}}$", "E(z)R$_{2500}$",
                                  x_lims=Quantity([1, 12], 'keV'), relation_name=r'R$_{2500}$-Temperature',
                                  relation_author='Vikhlinin et al.', relation_year='2006',
                                  relation_doi='10.1086/500288', dim_hubb_ind=1, core_radius_fraction=0.15,
                                  outer_aperture='R2500', telescope='chandra')