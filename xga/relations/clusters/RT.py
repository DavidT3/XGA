...
# These are from the classic M-T relation paper published by Vikhlinin, as R-T relations are a byproduct of M-T relations
vikhlinin_r2500 = ScalingRelation(np.array([1.64/3, 351]), np.array([0.06/3, 5]), power_law, Quantity(5, 'keV'),
                                  ...
                                  relation_year='2006', relation_doi='10.1086/500288', dim_hubb_ind=1)
