...
#  Last modified by David J Turner (turne540@msu.edu) 25/04/2023, 09:26. Copyright (c) The Contributors
            ...
            for bad_name in bad_gen:
                if bad_name in samp.names:
                    ...
                    warn("SASGenerationError parsing has recovered a string that is not a source name ({}), a "
                         "problem may not have been removed from the sample.".format(bad_name), stacklevel=2)
