...
if __name__ == "__main__":
    ...
    try:
        ...
        from daxa.exceptions import CIAONotFoundError, SASNotFoundError, eSASSNotFoundError
        from daxa.mission import Chandra, XMMPointed, eRASS1DE
        from daxa.process._backend_check import find_ciao, find_esass, find_sas
        from daxa.process.simple import full_process_chandra, full_process_erosita
        from daxa.process.xmm.assemble import cleaned_evt_lists, emchain, epchain, merge_subexposures
        ...
        test_coords = SkyCoord(
            ra=[SRC_INFO["ra"], SUPP_SRC_INFO["ra"]], dec=[SRC_INFO["dec"], SUPP_SRC_INFO["dec"]], unit="deg"
        )
