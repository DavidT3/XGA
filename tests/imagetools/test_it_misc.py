...
@pytest.mark.simple
@pytest.mark.data
@pytest.mark.parametrize("test_coord, test_wcs, test_offset, expected", [(A907_LOC, Image(,.radec_wcs,
                                                                          Quantity(1, 'arcmin'),
                                                                          Quantity(0.0012083328398207695, 'deg/pix')),
                                                                         (A907_LOC, Image(,.radec_wcs,
                                                                          Quantity(0.001, 'arcmin'),
                                                                          Quantity(0.0012083330447300933, 'deg/pix')),
                                                                         (OFF_PIX, Image(,.radec_wcs,
                                                                          Quantity(1, 'arcmin'),
...
@pytest.mark.simple
@pytest.mark.data
@pytest.mark.parametrize("test_im, test_coord, test_offset, expected", [(Image(,, A907_LOC,
                                                                         Quantity(1, 'arcmin'),
...
@pytest.mark.simple
@pytest.mark.data
@pytest.mark.parametrize("test_im, test_rad, out_unit, expected", [(Image(,, Quantity(103, 'pix'), 'deg',
                                                                    Quantity(0.12445828250153926, 'deg')),
                                                                   (Image(,, Quantity(103, 'pix'), 'kpc',
...
@pytest.mark.data
@pytest.mark.xfail
@pytest.mark.parametrize("test_im, test_rad, expected", [(Image(,, Quantity(0.12445828250153926, 'deg'),
                                                          Quantity(103, 'pix')),
                                                         (Image(,, Quantity(1275.5389422602298, 'kpc'),
                                                          Quantity(103, 'pix'))])
